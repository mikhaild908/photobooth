...
def initPygame():
    ...
    pygame.display.set_caption("- Lauren's 4th Birthday -")
...
def displayWaitMessage():
    showImage(REAL_PATH + "/please-wait.png")
    #time.sleep(1)
...
def displayTransitionAndGiveUserChanceToPrintPhoto(fileName):
    ...
    while not printButtonPressed and timeNow - startTime <= 10:
...
def putBorderToImage(fileName):
    graphicsmagick = "gm composite -geometry +0+0 1800x1200-background.png " + fileName + " " + fileName
